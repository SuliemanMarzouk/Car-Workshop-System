...
return [
    'tenant_model' => \App\Infrastructure\Tenancy\Models\Tenant::class,
     ...
     *
     * We use request data identification for the API (X-Tenant header by default).
     */
    'identification' => [
        'resolvers' => [
            RequestDataTenantResolver::class => [
                ...
                'cookie' => 'tenant',
                'tenant_model_column' => null, // null = tenant key (id)
                'cache' => false,
                'cache_ttl' => 3600,
                'cache_store' => null,
            ],
    ...
    'database' => [
        ...
        /**
         * Tenant database names on MySQL (Wamp): prefix + tenant_id + suffix.
         * Example: tenant id "workshop1" → database `tenant_workshop1`.
         * Uses credentials from the tenant_template connection (same host/user as central).
         */
